...
set DESIGN_NAME 		"spimemio" ;# Required; name of the design to be worked on; used as the block name for save_block or copy_block operations
...
set REFERENCE_LIBRARY 		"/home1/14_nmts/14_nmts/stdcell_hvt/ndm/saed14hvt_frame_only.ndm \
				   ...
				   /home1/14_nmts/14_nmts/stdcell_lvt/ndm/saed14lvt_frame_only.ndm";# Required; a list of reference libraries for the design library.
...
set LINK_LIBRARY	"/home1/14_nmts/14_nmts/stdcell_lvt/db_ccs/saed14lvt_ff0p88vm40c.db \
			/home1/14_nmts/14_nmts/stdcell_lvt/db_ccs/saed14lvt_ss0p72v125c.db \
			/home1/14_nmts/14_nmts/stdcell_rvt/db_ccs/saed14rvt_ff0p88vm40c.db \
		...
		/home1/14_nmts/14_nmts/stdcell_rvt/db_ccs/saed14rvt_dlvl_ff0p88vm40c_i0p7v.db \
		/home1/14_nmts/14_nmts/stdcell_rvt/db_ccs/saed14rvt_ulvl_ff0p88vm40c_i0p7v.db \
		...
		/home1/14_nmts/14_nmts/stdcell_lvt/db_ccs/saed14lvt_dlvl_ff0p88vm40c_i0p7v.db \
		/home1/14_nmts/14_nmts/stdcell_lvt/db_ccs/saed14lvt_ulvl_ff0p88vm40c_i0p7v.db";# Optional; specify a list of .db files
...
set CTS_LIB_CELL_PATTERN_LIST 		"*BUF_S_* *INV_S_*" ;# List of CTS lib cell patterns to be used by CTS; 
...
set PARASITIC_TECH_LIB		"set_tlu_plus_files \
...
-tech2itf_map \
/home1/14_nmts/14_nmts/tech/star_rc/saed14nm_tf_itf_tluplus.map"	;# Specifies one library as a dedicated parasitic technology library
...
##################################################
set TCL_MCMM_SETUP_FILE		"/home1/BPPD08/JhanaviD/VLSI_PD/Raven_soc/pnr/scripts/TCL_MCMM_SETUP_FILE.tcl"	;# Specify a Tcl script to create your corners, modes, scenarios and load respective constraints;
...
set TCL_PARASITIC_SETUP_FILE	"/home1/BPPD08/JhanaviD/VLSI_PD/Raven_soc/spimemio/pnr/scripts/TCL_PARASITIC_SETUP_FILE.tcl"	;# Specify a Tcl script to read in your TLU+ files by using the read_parasitic_tech command;					;# refer to the example in examples/TCL_PARASITIC_SETUP_FILE.tcl
...
##########################################################################################
set PLACE_OPT_ACTIVE_SCENARIO_LIST	"func::ff_0p72v125c" ;# A subset of scenarios to be made active during place_opt step;
...
set CLOCK_OPT_CTS_ACTIVE_SCENARIO_LIST  "func::ss_0p6vm40c turbo_func::ff_0p72v125c" ;# A subset of scenarios to be made active during clock_opt_cts step;
					;# once set, the list of active scenarios is saved and carried over to subsequent steps;
set ROUTE_OPT_ACTIVE_SCENARIO_LIST 	"func::ss_0p6vm40c turbo_func::ff_0p72v125c" ;# A subset of scenarios to be made active during route_opt step;
					;# once set, the list of active scenarios is saved and carried over to subsequent steps;
...
set VERILOG_NETLIST_FILES	"/home1/BPPD08/JhanaviD/VLSI_PD/Raven_soc/spimemio/pnr/outputs/spimemio.mapped.v"
;# Verilog netlist files;
					;# 	for DP: required
					;# 	for PNR: required if INIT_DESIGN_INPUT is set to ASCII; not required for DC_ASCII or NDM

set UPF_FILE 			"/home1/BPPD08/JhanaviD/VLSI_PD/Raven_soc/spimemio/pnr/scripts/spimemio.upf";# A UPF file
					;# 	for DP: required
					;# 	for PNR: required if INIT_DESIGN_INPUT is set to ASCII; not required for DC_ASCII or NDM
...
set UPF_SUPPLEMENTAL_FILE	"/home1/BPPD08/JhanaviD/VLSI_PD/Raven_soc/spimemio/synth/outputs/spimemio.supplement.upf"      ;# The supplemental UPF file. Only needed if you are running golden UPF flow, in which case, you need both UPF_FILE and this.
					;# 	for DP: required
					;# 	for PNR: required if INIT_DESIGN_INPUT is set to ASCII; not required for DC_ASCII or NDM
...
set OUTPUTS_DIR				"/home1/BPPD08/JhanaviD/VLSI_PD/Raven_soc/spimemio/pnr/outputs";# Directory to write output data files; mainly used by write_data.tcl
set REPORTS_DIR				"/home1/BPPD08/JhanaviD/VLSI_PD/Raven_soc/spimemio/pnr/reports";# Directory to write reports; mainly used by report_qor.tcl
set LOGS_DIR				"/home1/BPPD08/JhanaviD/VLSI_PD/Raven_soc/spimemio/pnr/log";# Directory to logs; mainly used by Makefile*
